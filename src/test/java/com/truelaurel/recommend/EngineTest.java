...
public class EngineTest {
    ...
    private Post post11 = new Post("hello world", "http://hui-wang.info/hello-world.html", Arrays.asList("hello", "world"));
    private Post post12 = new Post("hello france", "http://hui-wang.info/hello-france.html", Arrays.asList("hello", "france"));
    private Site site1 = new Site("hui-wang.info", Arrays.asList(post11, post12));
    private Post post21 = new Post("hello paris", "http://li-ming.info/hello-paris.html", Arrays.asList("hello", "paris"));
    private Post post22 = new Post("goodbye london", "http://li-ming.info/goodbye-london.html", Arrays.asList("goodbye", "london"));
    ...
    public void testSite2() throws Exception {
        ...
        Map<Post, List<Post>> result = new HashMap<>();
        result.put(post21, Collections.singletonList(post11));
